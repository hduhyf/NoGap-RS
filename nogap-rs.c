...
static const struct regval ov13850_nogap_regs[] = {
	{0x3500, 0x00}, //EXP	
    	{0x3501, 0x42},
    	{0x3502, 0x80}, //
    	{0x3509, 0x10}, //gain_mode//
    	{0x3503, 0x07}, //EXP_mode//
	{0x3612, 0x2f}, //CLK//
	{0x370a, 0x24},
	{0x372a, 0x04},
	{0x372f, 0xa0},
	...
	{0x3812, 0x00}, //offsety
	{0x3813, 0x00}, //
	{0x3820, 0x00}, //disable flip,mirror,subsample,bining,HDR
	{0x3821, 0x00}, //
	{0x3836, 0x04},
	{0x3837, 0x01}, 
	{0x4601, 0x87}, //VFIFO//
	...
	{0x4027, 0x1F},
	{0x4603, 0x00}, //VFIFO//
	{0x5000, 0x06}, //disable window,LENC//
	{0x5001, 0x01}, //disable MWB//
	{0x5401, 0x71},
	{0x5405, 0x80},
	{REG_NULL, 0x00},
};
...
static const struct ov13850_mode supported_modes[] = {
	{
		...
		.max_fps = {
			.numerator = 35840,
			.denominator = 120000000,
		},
		.exp_def = 0x0428,
		.hts_def = 0x00a0,
		.vts_def = 0x00e0,
		.reg_list = ov13850_nogap_regs,
	},{
		.width = 2112,
		.height = 1568,
		.max_fps = {
